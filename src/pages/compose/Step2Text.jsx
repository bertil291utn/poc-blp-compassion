  ...
  return (
    <div>
      <div className="px-4 pt-4 pb-2">
        ...
        <p className="text-sm text-gray-500 mt-0.5">Para: Jessica (mi patrocinadora)</p>
      </div>
      ...
      <div className="p-4">
        <textarea
          ...
          placeholder="Escribe tu carta aquí. Cuéntale a Jessica cómo estás, qué has hecho en la escuela, algo especial que quieras compartir..."
